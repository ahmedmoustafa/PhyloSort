...
import phylosort.util.NewickConstants;
...
public class TreeNode {
	...
	public static TreeNode find(TreeNode tree, String query, boolean regexp) {
		...
		if (regexp) {
			if (Pattern.matches(query, tree.getLabel())) {
				return tree;
			}
		} else {
			if (tree.getLabel().equalsIgnoreCase(query)) {
				return tree;
			}
		}
